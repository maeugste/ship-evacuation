...
text(10,240,sprintf('floor %i',floor_idx))
if floor_idx == 3
    text(10,120,sprintf('timestep: %0.5g',data.step-1),'color','white')
    text(10,120,sprintf('timestep: %0.5g',data.step),'color','black')
    text(10,150,sprintf('time: %0.5g s',data.time-data.dt),'color','white')
    text(10,150,sprintf('time: %0.5g s',data.time),'color','black')
end
