...
\textbf{Function:}
\newline 
The whole basic code has been copied and ajusted in several 
...
%\centering
%{\begin{minipage}[t]{7.4cm}
%\includegraphics[width=\textwidth]{ente.pdf}
...
%\centering
%{\begin{minipage}[t]{7.4cm}
%\includegraphics[width=\textwidth]{run1-added-stairs-small-rescueboatcapacity.pdf}
%\caption{Added stairs simulation: Boat capacities during simulation}
%\end{minipage}}
%{\begin{minipage}[t]{7.4cm}
%\includegraphics[width=\textwidth]{run1-added-stairs-small-agentsperfloor.pdf}
...
{|>{\large}m{2cm} |>{\center}b{1.1cm} |>{\center}b{1.1cm}|>{}b{1.1cm}|>{}b{1.1cm}|} \hline \hline
percentage of agents & 10\% &  50\% & 90\% & 95\% \\ \hline
evacuation time & XXXs &XXXs & XXXs & XXXs \\ \hline \hline
\end{tabular}
...
The Analysis of the simulation results showed that there is a huge potential in saving evacuation time. By adding just one additional staircase we were able to reduce the overall evacuation time by almost \textcolor{red}{XXXX} seconds. Further 50\% of all agents entered the exits approximately 2 seconds earlier compared to the stanard model. In contrast to that the rescueboat capacity utilisation remains basically the same.
...
But, there is clearly a difference in the second half of the evacuation. The last 10\% of agents are evacuated\textcolor{red}{XXXX} seconds faster and the last 1\% even\textcolor{red}{XXXX} seconds faster. 
